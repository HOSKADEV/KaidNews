    ...
    <div class="card-body">
      <div>
        <a class="btn btn-primary" href="javascript:void(0);" data-bs-toggle="modal"
            data-bs-target="#addSituationalModal">
            <i class='bx bx-list-plus me-2' ></i>
            {{ trans('expense.Add situational expenses') }}
        </a>
        @include('dashboard.expense.situational.add')
      </div>
    </div>
  </div>
  <div class="card mt-3">
            ...
            <div class="form-group col-md-2 mr-5 mt-4">
                @if (count($situationals))
                    <button target="_blank" id="printSection"
                        data-url="{{ route('dashboard.print.situational', [
            ...
            <tbody>
              ...
              <tr>
                ...
                @foreach ($situationals as $situational)
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal"
                                data-bs-target="#editSituationalModal{{ $situational->id }}">
                                <i class="bx bx-edit-alt me-2"></i>
                                {{ trans('expense.edit') }}
                            </a>
                            <a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="modal"
                                data-bs-target="#deleteSituationalModal{{ $situational->id }}">
                  ...
                  @include('dashboard.expense.situational.edit')
                  @include('dashboard.expense.situational.delete')
                @endforeach
                <tr>
                  <td></td>
